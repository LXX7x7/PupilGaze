#pragma once
#ifndef __H_DETECT_2D_H__
#define __H_DETECT_2D_H__
...
class Detector2D {
	...
	public:
		...
		Detector2D();
		int coarse_center1(cv::Mat m, int min_, int max_, cv::Rect& roi);
		std::shared_ptr<Detector2DResult> detect(Detector2DProperties& props, cv::Mat& image, cv::Mat& color_image, cv::Mat& debug_image, cv::Rect& roi, bool visualize, bool use_debug_image, bool pause_video = false);
