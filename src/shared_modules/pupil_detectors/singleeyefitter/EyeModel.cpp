...
#ifdef DEBUG_LOG
	std::cout << "EyeModel --*-- presentObservation --*-- mSupportingPupilSize" << mSupportingPupilSize << std::endl;
#endif
...
#ifdef DEBUG_LOG
	std::cout << "EyeModel --*-- presentObservation --*-- amountNewObservations:" << amountNewObservations << std::endl;
	std::cout << "EyeModel --*-- presentObservation --*-- pastSecondsRefinement:" << pastSecondsRefinement.count() << std::endl;
#endif
